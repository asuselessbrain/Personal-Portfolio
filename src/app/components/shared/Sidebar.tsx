...
const Sidebar = () => {
  return (
    <div
      className="fixed transform min-h-screen w-[256px] ease-in-out flex justify-start items-start bg-gray-900 flex-col"
    >
